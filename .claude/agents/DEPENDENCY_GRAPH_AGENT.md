...
{
    "dependency_graph": {
        "source_directories": ["src", "lib", ".claude"],
        "exclude_patterns": [
            "**/tests/**",
            "**/test_*.py",
            "**/__pycache__/**",
...
DEPGRAPH_SOURCE_DIRS=src,.claude
...
/agent-depgraph
"Build dependency graph for .claude/ codebase"
...
/agent-depgraph
"Generate Mermaid diagram of dependencies for .claude/rag/"
```
