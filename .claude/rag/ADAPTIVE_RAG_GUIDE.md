...
# Start RAG service
PROJECT_PATH=$(pwd) docker-compose -f .claude/rag/docker-compose.rag.yml up -d
...
#   .claude/context/QUERY_RESULTS.md (after queries)
```
...
- Ensure write permissions on `.claude/rag/chroma_db`
- Check disk space
- Try `--force-reindex`
