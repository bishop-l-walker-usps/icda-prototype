...
# Constants
MARKER_FILE = ".claude/.initialized"
RAG_DIR = ".claude/rag"
STATUS_FILE = ".claude/BOOTSTRAP_STATUS.json"
...
class BootstrapOrchestrator:
    ...
    def __init__(self, project_root: Optional[str] = None):
        ...
        self.rag_dir = self.claude_dir / "rag"
        self.marker_file = self.claude_dir / ".initialized"
        self.status_file = self.claude_dir / "BOOTSTRAP_STATUS.json"
    ...
    def run_conventions_analyzer(self) -> bool:
        ...
        try:
            ...
            conventions_file = self.claude_dir / "PROJECT_CONVENTIONS.json"
    ...
    def run(self, force: bool = False, interactive: bool = False) -> Dict[str, Any]:
        ...
        logger.info(f"Claude dir: {self.claude_dir}")
