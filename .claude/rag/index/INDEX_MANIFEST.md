...
- **markdown_section_f846e5b4_65** (markdown_section, L65-73)
  - Summary: - `.claude/URGENT_READ_FIRST.md` - Critical context from previous session...
...
- **markdown_section_af3f5359_110** (markdown_section, L110-117)
  - Summary: 1. `CLAUDE.md` - Component standards and naming conventions...
...
- **markdown_section_fdf922de_118** (markdown_section, L118-128)
  - Summary: 1. `CLAUDE.md` - Backend standards and testing requirements...
...
- **markdown_section_50e6310d_219** (markdown_section, L219-225)
  - Summary: - `.claude/` directory files are **authoritative**...
...
#### `.claude\agents\CODE_CONSOLIDATOR_AGENT.md`
...
- **markdown_section_a2f576e9_92** (markdown_section, L92-98)
  - Summary: ls -la output/test-project/.claude/...
...
- **markdown_section_c862764f_154** (markdown_section, L154-160)
  - Summary: grep -r "@claude" .claude/ 2>/dev/null || echo "✓ No Claude-specific syntax"...
...
- **markdown_section_5811715a_254** (markdown_section, L254-260)
  - Summary: cat .claude/*.md PLANNING.md | pbcopy...
...
- **markdown_section_41a77433_260** (markdown_section, L260-266)
  - Summary: 1. **.claude/CLAUDE.md** - Modify dev standards...
...
- **markdown_section_e18aa7d5_114** (markdown_section, L114-119)
  - Summary: ollama run codellama "$(cat .claude/CLAUDE.md .claude/INITIAL.md PLANNING.md)...
...
- **markdown_section_8e9640bd_128** (markdown_section, L128-138)
  - Summary: with open('.claude/CLAUDE.md') as f:...
...
- **markdown_section_be76c940_28** (markdown_section, L28-35)
  - Summary: 1. Read `.claude/CLAUDE.md` for development standards...
...
- **markdown_section_58ce7d61_7** (markdown_section, L7-19)
  - Summary: - `.claude/CLAUDE.md` - Universal development standards with communication style...
...
- **markdown_section_5a799af8_144** (markdown_section, L144-157)
  - Summary: See `.claude/INFRASTRUCTURE.md` for detailed Docker deployment guide....
...
- **markdown_section_3d26e630_41** (markdown_section, L41-56)
  - Summary: docker run --rm universal-context-template:latest sh -c "ls /template/.claude/ag...
...
#### `.claude\mcp-servers\unified-dev\models\__init__.py`
...
#### `.claude\mcp-servers\unified-dev\models\base.py`
...
#### `.claude\mcp-servers\unified-dev\models\claude.py`
...
#### `.claude\mcp-servers\unified-dev\models\codex.py`
...
#### `.claude\mcp-servers\unified-dev\models\custom.py`
...
#### `.claude\mcp-servers\unified-dev\server.py`
...
#### `.claude\mcp-servers\unified-dev\tools\memory_tools.py`
...
#### `.claude\mcp-servers\unified-dev\tools\model_tools.py`
...
#### `.claude\mcp-servers\unified-dev\tools\rag_tools.py`
...
#### `.claude\mcp-servers\unified-dev\utils\error_handler.py`
...
#### `.claude\mcp-servers\unified-dev\utils\validation.py`
...
#### `.claude\rag\chunking_strategy.py`
...
#### `.claude\rag\context7_integration.py`
...
#### `.claude\rag\conventions_analyzer.py`
...
#### `.claude\rag\progress_display.py`
...
#### `.claude\rag\rag_orchestrator.py`
