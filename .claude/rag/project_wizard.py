...
1. `.claude/CLAUDE.md` - Development standards
2. `.claude/CONVENTIONS.md` - Coding conventions
...
"""
        ...
        print(f"\nNext steps:")
        print(f"  1. Review .claude/CONVENTIONS.md")
        print(f"  2. Review any merged sections in .claude/CLAUDE.md")
