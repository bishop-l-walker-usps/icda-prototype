...
2. copilot-instructions.md - Development rules & standards
...
#### 🐛 **Bug Fixes**
```
copilot-instructions.md → ../TASK.md → test files → source code
```
...
#### 🧪 **Testing & Quality**
```
copilot-instructions.md → VALIDATION.md → test files
```
...
- `.github/URGENT_READ_FIRST.md` - Critical context from previous session
- `.github/SESSION_*.md` - Detailed session context and troubleshooting

### **PRIMARY** (Always Authoritative)
- `.github/copilot-instructions.md` - Development standards, testing requirements, Git workflow
- `.github/INITIAL.md` - Technical specifications, project requirements, examples
- `.github/INFRASTRUCTURE.md` - Environment setup, deployment configuration
...
1. `copilot-instructions.md` - Component standards and naming conventions
2. `PLANNING.md` - Frontend architecture patterns
3. Project source files
4. `../TASK.md` - Frontend-related current tasks

### **Backend Development**
1. `copilot-instructions.md` - Backend standards and testing requirements
...
### **File Authority**
- `.github/` directory files are **authoritative**
- Root directory may contain backup or symlinked versions
- When in doubt, use the `.github/` version
...
4. **Review `copilot-instructions.md` for development standards**
