...
python .github/rag/rag_pipeline.py --full

# Full enforcement with AI validation
python .github/rag/rag_pipeline.py --full --enforce

# Validate all chunks (thorough but slower)
python .github/rag/rag_pipeline.py --full --enforce --validate-all

# JSON output for programmatic use
python .github/rag/rag_pipeline.py --full --json
```
...
exec({
  command: `python .github/rag/rag_pipeline.py --full --enforce`,
...
1. **Load Context**
   - Read: .github/AGENT_SNAPSHOT.json (pristine state before changes)
   - Read: .github/AGENT_RAG_MAP.json (dependency map before changes)
   - Read: .github/CURRENT_PLAN.md (what was supposed to be done)
   - Read: .github/CLAUDE_STATUS.md (Claude's implementation notes)
...
8. **Generate Enforcement Report**
   - Create: .github/AGENT_REPORT.md (see template below)
...
- [x] copilot-instructions.md standards met
...
**State Files:**
- .github/AGENT_SNAPSHOT.json (pristine state)
- .github/AGENT_RAG_MAP.json (dependency map)
- .github/CURRENT_PLAN.md (what was planned)
- .github/CLAUDE_STATUS.md (implementation notes)
