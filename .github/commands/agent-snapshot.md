...
python .github/rag/rag_pipeline.py

# Index specific project
python .github/rag/rag_pipeline.py --project /path/to/project

# Full pipeline with all agents
python .github/rag/rag_pipeline.py --full

# JSON output for programmatic use
python .github/rag/rag_pipeline.py --json
```

### Option 2: Bootstrap CLI
```bash
# Run full bootstrap (includes snapshot)
python .github/rag/bootstrap.py
...
exec({
  command: `python .github/rag/rag_pipeline.py --full`,
...
4. **Generate Snapshot Artifacts**
   - Create: .github/AGENT_SNAPSHOT.json
     ```json
     {
   ...
   - Create/Update: .github/AGENT_RAG_MAP.json
     ```json
     {
       "rag_map_version": "1.0",
...
- .github/CURRENT_PLAN.md (input - read this first)
- .github/RAG_CONTEXT.md (patterns for dependency mapping)
- .github/INFRASTRUCTURE.md (infrastructure context)
...
Artifacts Created:
✓ .github/AGENT_SNAPSHOT.json (487 KB)
✓ .github/AGENT_RAG_MAP.json (152 KB)
✓ .github/AGENT_STATUS.md
