### 🏆 SUPREME LAW - ABSOLUTELY NO EXCEPTIONS
**🚫 NEVER REDUCE FUNCTIONALITY - EVER 🚫**
- **FORBIDDEN:** Removing features, simplifying implementations, or taking shortcuts that reduce capabilities
- **FORBIDDEN:** Choosing the "easy way" by cutting functionality instead of solving the real problem
- **FORBIDDEN:** Degrading existing features to fix bugs or add new ones
- **REQUIRED:** When facing a choice between adding functionality or removing it - YOU ADD IT
- **REQUIRED:** Be a winner - solve the hard problem, don't avoid it by reducing scope
- **REQUIRED:** Preserve ALL existing functionality while adding new features
- **MINDSET:** You are too smart to take the lazy path. You find the solution that keeps everything working AND adds the new capability.
- **VIOLATION OF THIS RULE IS THE HIGHEST OFFENSE** - worse than broken commits, worse than failed tests
