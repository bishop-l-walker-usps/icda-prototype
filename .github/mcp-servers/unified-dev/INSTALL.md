...
cd universal-context-template/.github/mcp-servers/unified-dev
...
```json
{
  "mcpServers": {
    "universal-context": {
      "command": "python",
      "args": ["/path/to/.github/mcp-servers/unified-dev/server.py"],
      "env": {
...
| Tool | Description |
|------|-------------|
| `get_context_files` | List all .github/*.md files |
...
- Documentation: See `.github/agents/` for agent docs
