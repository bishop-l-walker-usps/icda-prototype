...
```bash
# Copy RAG system
cp -r UNIVERSAL_CONTEXT_TEMPLATE/.github/rag/ your-project/.github/rag/

# Copy MCP server
cp -r UNIVERSAL_CONTEXT_TEMPLATE/.github/mcp-servers/unified-dev/ your-project/.github/mcp-servers/your-project-dev/
```

### 2. Install Dependencies
```bash
cd your-project/.github/rag && pip install -r rag_requirements.txt
...
See full documentation at: `.github/mcp-servers/unified-dev/CUSTOMIZATION.md`
