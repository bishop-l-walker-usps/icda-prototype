...
async def list_tools() -> list[Tool]:
    ...
    return [
        ...
        Tool(
            ...
            description="Get list of all context files (.github/*.md)",
            inputSchema={
                "type": "object",
                "properties": {}
            }
...
async def _install_template(target_path: str, include_agents: bool = True, include_rag: bool = True) -> dict:
    ...
    return {
        ...
        "next_steps": [
            ...
            "Customize .github/CLAUDE.md for your standards"
        ]
    }
