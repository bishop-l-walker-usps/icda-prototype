...
class FileInjectAdapter(InterfaceAdapter):
    ...
    def __init__(self, output_dir: str = ".github/context"):
...
class AdaptiveRAGEngine:
    ...
    def __init__(self, project_root: str = "."):
        ...
        self.vector_db = ChromaVectorDatabase(
            persist_directory=str(self.project_root / ".github" / "rag" / "chroma_db")
        )
    ...
    def _analyze_and_save_conventions(self):
        ...
        try:
            ...
            conventions_file = self.project_root / ".github" / "CONVENTIONS.md"
